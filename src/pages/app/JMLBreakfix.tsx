...
import { Calendar, MapPin, Phone, User, Laptop, Wrench, ArrowLeft, ArrowRight, Loader2, CheckCircle2, Plus, X, Building2, AlertCircle, UserPlus, Package, Calculator } from "lucide-react";
                      ...
                      <div className="flex gap-3 items-end">
                        ...
                        {shouldShowDeviceType(device.category) && (
                          <div className="space-y-2 flex-1">
                            ...
                            <RadioGroup value={device.deviceType || 'Windows'} onValueChange={(value) => updateBrokenDevice(index, 'deviceType', value as 'Windows' | 'Apple')}>
