        ...
        if (selectedNewSiteId === "new") {
          ...
          if (selectedSite) {
            ...
            const booking = await jmlBookingService.createMover({
              ...
              currentLat,
              currentLng,
              currentDevices: currentDevices.filter(d => d.category && d.make && d.model && d.quantity >= 1 && d.deviceType),
              lat: bookingLat,
              lng: bookingLng,
            });
                      ...
                      <div className="flex gap-3 items-end">
                        ...
                        {shouldShowDeviceType(device.category) && (
                          <div className="space-y-2 flex-1">
                            ...
                            <RadioGroup value={device.deviceType || 'Windows'} onValueChange={(value) => updateCurrentDevice(index, 'deviceType', value as 'Windows' | 'Apple')}>
