...
export const mockJobs: Job[] = [
  {
    ...
    driver: { id: 'user-4', name: 'James Wilson', vehicleReg: 'AB12 CDE', vehicleType: 'van', phone: '+44 7700 900123' },
    co2eSaved: 26150,
    travelEmissions: 45,
    buybackValue: 5875,
    charityPercent: 10,
  ...
  // Additional finalised jobs for driver history testing (assigned to James Wilson)
  {
    id: 'job-019',
